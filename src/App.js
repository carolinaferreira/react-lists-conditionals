      ...
      <div className="App">
        ...
        <ol>
          <li>Create an input field (in App component) with a change listener 
              ...
              paragraph).</li>
          <li>Create a new component (=> ValidationComponent) which receives the
              text length as a prop</li>
          ...
          <li>Render a list of CharComponents where each CharComponent receives
